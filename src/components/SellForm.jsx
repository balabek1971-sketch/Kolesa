  ...
  if (submittedId) {
    ...
    return (
      <section className="sell sell-success">
        ...
        <p className="eyebrow">{published ? "Проверяем медиа" : "Черновик сохранён"}</p>
        <h1>{published ? "Объявление отправлено на проверку" : "Можно продолжить позже"}</h1>
        <p>
          {published
            ? "Обычно это занимает несколько секунд, с видео — до минуты. После проверки объявление автоматически появится в поиске."
